...
export const fetchMovieAsync = createAsyncThunk('movies/list', async (props: {limit: number, offset: number}) => {
...
export const searchMovieAsync = createAsyncThunk('movies/search', async (props: {title: string}) => {
    const { title} = props;
